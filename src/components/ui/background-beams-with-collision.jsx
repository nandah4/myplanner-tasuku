...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    (<div
      ref={parentRef}
      className={cn(
        "h-full md:h-full bg-gradient-to-b from-white to-neutral-100 dark:from-white dark:to-slate-200 relative flex items-center w-full justify-center overflow-hidden",
